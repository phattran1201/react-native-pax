 ...
 */
export function initPOSLinkConn(config: PaxConnConfig): Promise<PaxInitModel> {
 ...
 */
export function requestUsbPermission(): Promise<boolean> {
 ...
 */
export function listUsbDevices(): Promise<PaxUsbDevice[]> {
 ...
 */
export function getSupportedBaudRates(): Promise<string[]> {
 ...
 */
export function checkBluetoothEnable(): Promise<boolean> {
...
export function startBluetoothSearch(options?: {
  ...
  return PaxPosLink.startBluetoothSearch(
    options?.useBle ?? false,
 ...
 * @returns {Promise<boolean>}
 */
export function stopBluetoothSearch(): Promise<boolean> {
 ...
 */
export function getBluetoothDeviceList(): Promise<PaxBtDevice[]> {
